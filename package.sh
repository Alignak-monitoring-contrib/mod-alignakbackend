...
# --------------------------------------------------------------------------------
# This script is building packages for Alignak-Backend modules thanks to the fpm
...
pkg_name="${python_prefix}-alignak-module-backend"
pkg_description="Alignak backend modules for Alignak"
